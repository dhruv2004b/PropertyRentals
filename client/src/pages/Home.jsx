    ...
    <div>
      ...
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm ">
          <span className='text-slate-700 font-semibold'>PropLet</span> is the One Stop Website to find you next perfect place to live.
          <br />
      ...
      {/* {listing results for sale offer and rent} */}
